...
/**
 * Unsynchronized copy-and-paste of {@link ByteArrayOutputStream}. 
 */
public class PeekableByteArrayOutputStream extends OutputStream {
    ...
    String toLine() {
        ...
        return new String(buf, 0, count - 2, StandardCharsets.UTF_8);
    }
}